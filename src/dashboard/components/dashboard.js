                ...
                <React.Fragment>
                    ...
                    <div className="dashboard_container">
                        <div className="dashboard_wrapper">
                            ...
                            <div>
                                <p>
                                    Track your carb, protein and fat intake in
                                    grams
                                </p>
                                <p>Enter all fields or form will not submit</p>
                                <p>
                                    Only enter the numbers in inputs. No letters
                                </p>
                        ...
                        <div className="dashboard_wrapper">
                            ...
                            <div>
                                ...
                                <p>
                                    Enter 0 for bodyweight exercises in the
                                    weight input
                                </p>
                            </div>
                        </div>
                        <div className="dashboard_wrapper">
                            ...
                            <div>
                                ...
                                <p>
                                    Contact for more info to set up a free
                                    consultation
                                </p>
                                <a
                                    class="contact_icon"
